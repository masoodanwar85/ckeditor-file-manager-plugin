...
<head>
    ...
    <script>
		...
		function preview(fileName) {
			...
			img.src = '<cfoutput>#baseURL#</cfoutput>/'+fileName;
        ...
        function returnFileUrl() {
            ...
            var fileUrl = document.getElementById('preview').children[0].src;
...
<body>
	...
	<cfset qryListDirectory = directoryList(basePath,true,'query', filterBySize) />
	...
	<cfoutput query="qryListDirectory">
		<tr>
			...
			<td>
				<a href="javascript:void(0);" onclick="preview('#qryListDirectory.name#')" path="#qryListDirectory.directory#">
					#qryListDirectory.name#</a>
					(#qryListDirectory.directory#)
				</td>
		</tr>
	</cfoutput>
	</table>
